...
function socialit_update_check(){
	...
	if($latest_ver && version_compare($latest_ver, SOCIALIT_vNum, '>')){
		return $latest_ver;
	}else{
		return false;
	}
...
function socialit_settings_page() {
	...
	if(isset($_POST['save_changes'])) {
		...
		if (!$error_message) {
			...
			$socialit_plugopts['shortyapi']['supr']['user'] = $_POST['shortyapiuser-supr'];
			$socialit_plugopts['shortyapi']['supr']['key'] = $_POST['shortyapikey-supr'];
			$socialit_plugopts['shortyapi']['trim']['chk'] = $_POST['shortyapichk-trim'];
			$socialit_plugopts['shortyapi']['trim']['user'] = $_POST['shortyapiuser-trim'];
			...
			$socialit_plugopts['shortyapi']['tinyarrow']['user'] = $_POST['shortyapiuser-tinyarrow'];
...
?>
	...
	<div class="box-right">
		<div class="box-right-head">
			...
			<h3><?php _e('Plugin Sponsors', 'socialit'); ?></h3>
		</div>
		<div class="box-right-body">
			<div class="padding">
				<ul>
					<li>
						<a href="http://gaut.am/" title="Visit our Website!" target="_blank">
							<img src="http://gaut.am/uploads/banners/s2.gif" alt="Follow us on Twitter - @Gaut_am | Visit our Website - http://gaut.am/" />
						</a>
					</li>
				</ul>
			</div>
